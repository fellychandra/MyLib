        ...
        binding.btnOke.setOnClickListener {
            ...
            if (a == 1) {
                ...
                view.btnsimpan.setOnClickListener {
                    databaseReference2?.child("2055301050")?.get()?.addOnSuccessListener {
                        if (it.exists()) {
                            ...
                            //Toast.makeText(applicationContext,"${inputpass}", Toast.LENGTH_SHORT).show()
                            if (pass.equals(inputpass)) {
                                //Toast.makeText(applicationContext, "OK" , Toast.LENGTH_SHORT).show()
                                databaseReference1?.child(kode)?.get()?.addOnSuccessListener {
                                    //it.child("judul").value.toString()
                                    //oast.makeText(applicationContext, "OKess ${it}" , Toast.LENGTH_SHORT).show()
                                    //AP
                                    val emails = email
